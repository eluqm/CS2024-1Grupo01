...
<body>
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                              <img class="col-md-12" src="img/logo.jpg" alt="" style="width: 100%;height: 90px;">
                            </a>
                        </div>
                        <br>
                        ...
                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Acceder</button>
                    </div>
                  </form>
                </div>
            </div>
    ...
    $("#FormLogin").validate({ debug: true,
        ...
        submitHandler: function(form){
          guardarForm("pages/admin/checkUser.php", "FormLogin", function(resultado){
          if (resultado == "err:ok") {
